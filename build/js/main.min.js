...
var setInitialHeaderState = function setInitialHeaderState() {// if (document.querySelector('.wrapper').offsetTop <= 0) {
...
var toggleHeaderState = function toggleHeaderState() {
  ...
  var hasVScroll = document.body.offsetHeight - difference > document.documentElement.clientHeight; // Desktop
...
var setScrollListener = function setScrollListener() {
...
function init() {
  ...
  myMap.controls.add('typeSelector'); // const addresses = ['Москва, Строителей улица, дом 15', 'Москва, Рябиновая улица, дом 53'];
  // Отрисовываем точки
