...
/* harmony import */ var _modules_slider_init_recipes_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slider/init-recipes-slider */ "./js/modules/slider/init-recipes-slider.js");
/* harmony import */ var _modules_animation_background_parallax__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/animation/background-parallax */ "./js/modules/animation/background-parallax.js");
...
Object(_modules_init_video_play_btn__WEBPACK_IMPORTED_MODULE_4__["initVideoPlayBtn"])(); // Sliders

Object(_modules_slider_init_recipes_slider__WEBPACK_IMPORTED_MODULE_5__["initRecipesSlider"])(); // Animation

Object(_modules_animation_background_parallax__WEBPACK_IMPORTED_MODULE_6__["backgroundParallax"])();

/***/ }),

/***/ "./js/modules/animation/background-parallax.js":
/*!*****************************************************!*\
  !*** ./js/modules/animation/background-parallax.js ***!
  \*****************************************************/
/*! exports provided: backgroundParallax */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "backgroundParallax", function() { return backgroundParallax; });
...
var DEFAULT_ROTATE_DIVISOR = 4;
var windowHeight;

var calculateParallax = function calculateParallax(el, movement, offsetTop, rotate, rotateACW, rotateDivisor, onlyRotate) {
  var part = windowHeight / movement;
  var currentMovement;

  if (offsetTop >= windowHeight - part) {
    el.style.transform = null;
  } else {
    var currentRotation = Math.trunc(Math.abs(offsetTop - windowHeight) / part);
    ...
    if (rotate) {
      if (!rotateACW) {
        el.style.transform = "translateY(".concat(currentMovement, "px) rotate(").concat(currentRotation / rotateDivisor, "deg)");
      } else {
        el.style.transform = "translateY(".concat(currentMovement, "px) rotate(-").concat(currentRotation / rotateDivisor, "deg)");
      }
    } else {
      el.style.transform = "translateY(".concat(currentMovement, "px)");
    }
  }
};
...
var initParallax = function initParallax() {
  ...
  parallaxNodes.forEach(function (el) {
    ...
    var movement = +el.dataset.movement;
    var rotate = Boolean(el.dataset.rotate);
    var rotateACW = Boolean(el.dataset.rotateAcw);
    var onlyRotate = Boolean(el.dataset.onlyRotate);
    var rotateDivisor;
...
var backgroundParallax = function backgroundParallax() {
